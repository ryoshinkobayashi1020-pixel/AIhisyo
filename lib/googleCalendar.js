...
export async function isShootingSlotAvailable(startIso, durationMinutes = 120, travelMinutes = 60) {
...
export async function createShootingEvent({ startIso, title, description = "" }) {
  const start = new Date(startIso);
