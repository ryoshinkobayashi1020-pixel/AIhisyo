...
${job.manaLanguageReview ? `マナコーポレーション求人台本の企画ルール:
- ユーザーが「台本作って」のように短く依頼した場合も質問で止めず、今回の対象者とテーマを自分で決めて完成台本を作る
- 1本につき対象者は必ず1種類に絞る。「美容師免許を持つ転職希望者」「美容学校に通う学生」「免許取得前で理美容師を目指す人」など、条件の異なる人を同じ台本でまとめて呼びかけない
- 対象者に合わせて、登録済みの3つの土台台本から最も近い構成を一つだけ使う
- 冒頭は「石川県で転職を考えている美容師の方へ」のように、選んだ対象者へ直接呼びかける
- 「今回の動画は、こんな方に向けた求人動画です」「ぜひ最後までご覧ください」のような動画説明や前置きから始めない
- 冒頭で対象者を箇条書きにしない。対象者が抱える具体的な悩み、生活上の不安、将来の迷いへすぐ入る
- 自動で選んだ対象者や構成を制作説明として出力せず、読み上げる完成台本だけを出力する
...
11. 1本の中で資格保有者、美容学生、無資格者など異なる対象者を混ぜていないか確認する。混ざっていたら一人に絞って全体を書き直す
...
- 基本の質問役は「スタッフ」ではなく「カメラマン」と表記し、最初の質問だけで今回のテーマが分かる
- 美容師本人の経験や現場の実感が必要なテーマでは、「カメラマン」「瀬川社長」「美容師スタッフ」の3人形式にする。美容師スタッフの未登録の氏名、勤続年数、役職、実績は作らない
- 3人形式ではカメラマンが質問を振り、美容師スタッフが現場の実感を話し、瀬川社長が会社の考え方や背景を補足する。人数を増やすだけの発言は入れない
- 求人や働き方の3人形式では、美容師スタッフが「入社前の具体的な不安→マナの何が良かったか→生活や気持ちがどう変わったか」を自分の言葉で話している
- 3人形式を求人インタビューだけに固定しない。カメラマンの一つの質問に、美容師スタッフが現場の実感、瀬川社長が経営者としての理由や経験を答えるシンプルな会話形式も、テーマに応じて使う
- シンプルな3人会話でも、会社としての「人を大切にする」「お客様に愛される人づくり」「信頼と愛情の循環」と、登録済みの瀬川社長の想い・仕事観・失敗経験のうちテーマに合うものが自然に表れている
- 美容師スタッフと瀬川社長が同じ内容を繰り返さず、現場側と経営側で異なる視点を加える
- 出来高制ではないこと、収入の安定、直接雇用、社会保険、育成環境、人を大切にする会社という登録済みの強みから、テーマに合うものだけを使う
- 家賃や生活費、結婚などの将来設計へ自然につなげてよいが、未確認の給与額、手取り額、年齢、家族構成、実在スタッフの個人史は作らない
- 「めちゃくちゃ良かった」のような感想だけで終わらず、何がどの不安を軽くしたのかが直前の会話から分かる
- 1行目に「新店舗の店長を決めるとき」「新人教育を任せるとき」など、なぜ今その質問をするのか分かる場面がある。確認できない出来事は「作るとしたら」のような仮定にする
- 「店長って」「独立って」だけで突然始まる抽象的な質問は、具体的な状況を含む質問へ直す
- 2人形式ではカメラマンと瀬川社長、3人形式では美容師スタッフも交え、質問と回答が最低3往復あり、基本5〜8往復ある
...
- カメラマンや美容師スタッフを無知として笑わず、瀬川社長も肩書きで押し切らない
...
- 文法上は成立していても、普段の会話で言わない不自然な言葉の組み合わせを残さない
- 「喜べるかも見ます」は「一緒に喜べる人かどうかも大切です」、「人が育たない時」は「スタッフの成長が思うように進まないとき」のように自然な日本語へ直す
- 一文へ理由と結論を詰め込みすぎず、「直すべき点を伝える」「次の改善を一緒に考える」のように行動を分けて話す
- 質問と回答の動詞をそろえ、「そう考えられていたんですか？」に「できていませんでした」と返すような受け答えのずれを直す
- カメラマンが「技術より信頼」と誤って二者択一にした場合、社長は最後まで待たず、その場で「技術に加えて信頼も必要」と自然に訂正する
- 「みんな」「周り」など対象が曖昧な言葉は「後輩スタッフ」「同じ店舗のスタッフ」などへ具体化する
- 「安心してついていきやすい」のように言葉を重ねず、誰が何をしやすいのかを一つの行動で表す
- 「上手い人を上に立たせる」のような不自然な役職表現を、「技術が上手い人を店長にする」のように言い換える
