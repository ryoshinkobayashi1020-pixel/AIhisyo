  ...
  const defaultScriptPrompt = staffId === "elf_lively"
    ...
    : elfScriptStaff
      ...
      : staffId === "mana_staff_dialogue"
        ? "【マナコーポレーション・スタッフ駆け引き台本プロンプト】\n基本は「カメラマン」と瀬川社長による質問、即答、反論、具体化、再質問の自然な駆け引き台本を作ってください。内容によっては「カメラマン」「瀬川社長」「美容師スタッフ」の3人にし、美容師スタッフへのインタビューと社長の補足を交えてください。美容師スタッフの未登録の個人情報は作らないでください。見本チャンネルの足場業界の内容は、美容師の働き方、育成、独立、店長、接客、人を大切にする経営へ置き換えてください。指示が短い場合はテーマ、対象者、2人形式か3人形式かを自分で決めてください。出力は話者名と実際に話すセリフだけにしてください。"
        : staffId === "miyabis_ads"
