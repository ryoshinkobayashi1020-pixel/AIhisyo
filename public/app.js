  ...
  const defaultScriptPrompt = staffId === "elf_lively"
    ...
    : elfScriptStaff
      ...
      : staffId === "mana_staff_dialogue"
        ? "【マナコーポレーション・スタッフ駆け引き台本プロンプト】\n瀬川社長と美容室スタッフの質問、即答、反論、具体化、再質問による自然な駆け引き台本を作ってください。見本チャンネルの足場業界の内容は、美容師の働き方、育成、独立、店長、接客、人を大切にする経営へ置き換えてください。指示が短い場合はテーマと対象者と会話型を自分で決めてください。出力は話者名と実際に話すセリフだけにしてください。"
        : staffId === "miyabis_ads"
