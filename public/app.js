  ...
  const defaultScriptPrompt = staffId === "elf_lively"
    ...
    : elfScriptStaff
      ...
      : staffId === "mana_staff_dialogue"
        ? "【マナコーポレーション・スタッフ駆け引き台本プロンプト】\n基本は「カメラマン」と瀬川社長による質問、即答、反論、具体化、再質問の自然な駆け引き台本を作ってください。内容によっては「カメラマン」「瀬川社長」「美容師スタッフ」の3人にし、美容師スタッフへのインタビューと社長の補足を交えてください。求人や働き方のインタビューでは、美容師スタッフが入社前の具体的な不安、マナの何が良かったか、生活や気持ちがどう変わったかを順につなげて話してください。出来高制ではないこと、収入の安定、直接雇用、社会保険、育成環境、人を大切にする会社という登録済みの強みからテーマに合うものを選び、家賃、生活費、結婚など現実の将来設計へ自然につなげてください。未確認の給与額、家族構成、実在スタッフの個人情報は作らないでください。見本チャンネルの足場業界の内容は美容業界へ置き換えてください。指示が短い場合はテーマ、対象者、2人形式か3人形式かを自分で決めてください。出力は話者名と実際に話すセリフだけにしてください。"
        : staffId === "miyabis_ads"
